...
<style>
  ...
  .bar-btn:hover { background: rgb(255 255 255 / 8%); color: #fff; }
  .bar-btn.active { background: rgb(155 120 255 / 25%); color: #fff; border-color: rgb(155 120 255 / 40%); }
  ...
  .history-item:hover { background: rgb(255 255 255 / 6%); }
  .history-mode {
    flex-shrink: 0;
    ...
    background: rgb(52 211 153 / 26%); color: #acc4ff;
  }
  .history-mode.agent { background: rgb(155 120 255 / 25%); color: #d2bcff; }
  ...
  .resize-grip {
    ...
    cursor: nwse-resize;
    background:
      linear-gradient(135deg, transparent 0 50%, rgb(255 255 255 / 35%) 50% 60%, transparent 60% 70%, rgb(255 255 255 / 35%) 70% 80%, transparent 80%);
    z-index: 10;
  }
  ...
  .mic-btn:hover { background: rgb(255 255 255 / 6%); }
  .mic-btn.recording {
    color: #fff;
    background: #e5534b;
    border-color: #e5534b;
  ...
  .min-dot {
    ...
    box-shadow: 0 4px 16px rgb(123 92 255 / 50%);
  ...
  .min-dot.done {
    ...
    box-shadow: 0 4px 16px rgb(46 204 113 / 50%);
  }
  @keyframes dotpulse {
