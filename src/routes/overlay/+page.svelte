...
<style>
  ...
  .dot.live {
    background: #f8534b;
    box-shadow: 0 0 0 0 rgb(248 83 75 / 60%);
    animation: pulse-dot 1.3s ease-out infinite;
  }

  @keyframes pulse-dot {
    0% { box-shadow: 0 0 0 0 rgb(248 83 75 / 55%); }
    70% { box-shadow: 0 0 0 7px rgb(248 83 75 / 0%); }
    100% { box-shadow: 0 0 0 0 rgb(248 83 75 / 0%); }
  }
